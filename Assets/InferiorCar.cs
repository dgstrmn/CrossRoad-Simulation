...
public class InferiorCar : MonoBehaviour
{
    float speed = 10f;
    float speedDV;
    bool stopped = false;
    ...
    {
        if (collision.gameObject.CompareTag("Stopper For Cars") || collision.gameObject.CompareTag("Super Car") || collision.gameObject.CompareTag("Car") || collision.gameObject.CompareTag("Player"))
        {
